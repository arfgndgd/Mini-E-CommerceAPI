...
namespace ECommerceAPI.Persistence.Concretes
{
    public class ProductService : IProductService
    {
        ...
        public List<Product> GetProducts() => new() 
        {
            ...
            new() { Id = Guid.NewGuid(), Name = "Product 2", Price = 200, Stock =50},
            new() { Id = Guid.NewGuid(), Name = "Product 3", Price = 300, Stock = 50},
            new() { Id = Guid.NewGuid(), Name = "Product 4", Price = 400, Stock = 50},
            new() { Id = Guid.NewGuid(), Name = "Product 5", Price = 500, Stock =50},
            new() { Id = Guid.NewGuid(), Name = "Product 6", Price = 600, Stock = 50}
