...
namespace ECommerceAPI.Infrastructure.Services.Storage
{
    ...
    {
        protected delegate bool HasCurrentFile(string pathOrContainerName, string fileName); //delegate referans türlüdür.
        protected async Task<string> FileRenameAsync(string pathOrContainerName, string fileName, HasCurrentFile hasFileMethod, bool first = true)
        {
