...
public class FileService : IFileService
{
    ...
    public async Task<List<(string fileName, string path)>> UploadAsync(string path, IFormFileCollection files)
    {
        ...
        //todo Eğer yukarıdaki if geçerli değilse burada dosyaların sunucuda yüklenirken hata aldığına dair uyarıcı bir exception oluşturup fırlatılması gerekiyor
    }
}
